 ...
 *
 *	$Id: br_ioctl.c,v 1.4 2004/12/16 14:12:06 gopal_kr Exp $
 *
			   ...
			   unsigned long arg2)
{
	...
	/*TXTL_IGMP01 20-oct-2004*/
        case BRCTL_DELETE_MFD_V1_PORTS:
        	return br_mfd_delete_v1_ports(br);
	case BRCTL_MFD_DISPLAY:
		return br_mfd_get_entries(br, (void *)arg0);
#ifdef CONFIG_BRIDGE_CONF_MODE
	case BRCTL_ENABLE_PROXY_MODE:
		return br_enable_proxy_mode(br);
	case BRCTL_DISABLE_PROXY_MODE:
		return br_disable_proxy_mode(br);
#endif
	case BRCTL_GET_MC_STATUS:
		return br_get_mc_status(br, (void *)arg0);
#endif

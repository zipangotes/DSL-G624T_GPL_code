 ...
 *
 * Version:	$Id: tcp_input.c,v 1.1.1.1 2002/03/18 15:12:19 jharrell Exp $
 *
	     ...
	     struct sk_buff *tail, u32 start, u32 end)
{
	...
	while (before(start, end)) {
		...
		/* BUG fix- cb[45] should be zero when using alloc_skb - It will be set to one when using ti_alloc_skb */
		nskb->cb[45] = 0;

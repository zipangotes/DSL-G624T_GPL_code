...
static int input_map=INPUT_MAP;
static int output_map=OUTPUT_MAP;
...
tikpad_init(void)
{
	...
	kpad_info.input_map = input_map;
	kpad_info.output_map = output_map;
...
MODULE_PARM(input_map,"i");
MODULE_PARM(output_map,"i");

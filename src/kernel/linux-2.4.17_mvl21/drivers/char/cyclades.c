...
static char rcsid[] =
"$Revision: 1.1.1.1 $$Date: 2003/06/23 22:18:25 $";
 ...
 *
 * $Log: cyclades.c,v $
 * Revision 1.2  2002/11/07 22:50:20  marian
 * high res timers merge
 *
 * Revision 1.1.1.1.4.1  2002/10/28 14:35:28  jharrell
 * First import of Nick's High Res. Timer support for the Avalanche code base
 *
 * Revision 1.1.1.1  2002/03/18 15:11:48  jharrell
 * 2.4.17 sherman import
 *

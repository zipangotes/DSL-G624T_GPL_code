...
extern int timeout, retry, poll_interval;
extern int curr_serv;
extern int curr_attempt;
extern char *sntp_serv[3];
extern int in_timer;
...
extern int run_client (char *hostnames[], int nhosts);

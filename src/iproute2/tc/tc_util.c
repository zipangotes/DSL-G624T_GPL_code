...
#else
	if (tmp >= 1024*1023 && fabs(1024*1024*(long)(tmp/(1024*1024)) - tmp) < 1024)
		snprintf(buf, len, "%luMbit", (long)(tmp/(1024*1024)));
	else if (tmp >= 1024-16 && fabs(1024*(long)(tmp/1024) - tmp) < 16)
		snprintf(buf, len, "%luKbit", (long)(tmp/1024));
	else
		snprintf(buf, len, "%ubps", rate);
#endif
	return 0;
...
#else
	if (sz >= 1024*1024 && fabs(1024*1024*(long)(tmp/(1024*1024)) - sz) < 1024)		
		snprintf(buf, len, "%luMb", (long)(tmp/(1024*1024)));
	else if (sz >= 1024 && fabs(1024*(long)(tmp/1024) - sz) < 16)
		snprintf(buf, len, "%luKb", (long)(tmp/1024));
	else
		snprintf(buf, len, "%ub", sz);
#endif
	return 0;

...
#ifdef CONFIG_BRIDGED_MULTICAST
/* TXTL-IGMP01 - Following attributes added for Bridge */
struct mc_status
{
	u_int8_t mc_forwarding;
...
/* TXTL-IGMP01 - MFD Entry at Bridge */
struct mfd_entry
{
	u_int32_t grp_addr;
	int no_ports;
	int port_list[MAX_MCGRP_MEMBERS];
	u_int8_t vinfo_list[MAX_MCGRP_MEMBERS];       		
};
#endif
...
#ifdef CONFIG_BRIDGED_MULTICAST
/* TXTL-IGMP01 - prototypes for mc_status and read_mfd */

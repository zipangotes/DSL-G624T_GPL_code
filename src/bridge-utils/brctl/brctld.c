...
"setfilter\t<state>\t\tturn bridge filter on/off\n"
"addfilter\t<dport> <sport> <dst> <src> <proto> <deny|allow>\n\t\tadd entry to filter table\n"
"delfilter\t<dport> <sport> <dst> <src> <proto> <deny|allow>\n\t\tdelete entry in filter table\n"
"flushfilter\t\t\tflush bridge filtering table\n"
...
void runchild(int sock)
{
	...
	while (1) {
		...
		numcmd = sscanf(line, "%s %s %s %s %s %s %s", cmd, arg0, arg1, arg2, arg3, arg4, arg5);
		...
		br_refresh();
		cmdptr->func(br, arg0, arg1, arg2, arg3, arg4, arg5);
		printf("\n");
	}

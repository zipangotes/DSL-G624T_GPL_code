...
"\tshowmcgrp\t<bridge>\t\tdisplay list of multicast groups with members\n";
#else
;
#endif
...
int main(int argc, char *argv[])
{
	...
	return cmd->func(br, argv[argindex], argv[argindex+1], argv[argindex+2], argv[argindex+3], argv[argindex+4], argv[argindex+5]);

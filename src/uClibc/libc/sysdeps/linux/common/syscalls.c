...
/* **************************************************************************
The following definitions of syscalls are misleading as the syscall defs
are included from the kernel unistd.h file. For example, the pivot_root system
call is 217 according to this table, but according to the MIPS kernel it is 216.
Don't uncomment anything here as it will only mess things up.
***************************************************************************** */
